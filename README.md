...
> Add sample images to an `assets/` or `images/` folder in this repo (e.g. `images/sample_normal.png`, `images/sample_pneumonia.png`) and reference them here for a visual preview, for example:
>
> ```markdown
> | Normal | Pneumonia |
> |--------|-----------|
